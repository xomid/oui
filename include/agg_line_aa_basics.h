...
namespace agg
{
    ...
    //-------------------------------------------------------------------------
    enum AGG_API line_subpixel_scale_e
    {
    ...
    //-------------------------------------------------------------------------
    enum AGG_API line_mr_subpixel_scale_e
    {
    ...
    //==========================================================line_parameters
    struct AGG_API line_parameters
    {
        //---------------------------------------------------------------------
        line_parameters() {}
