...
namespace agg
{
    ...
    enum AGG_API gradient_subpixel_scale_e
    {
    ...
    //========================================================gradient_radial_d
    class AGG_API gradient_radial_d
    {
    public:
        static AGG_INLINE int calculate(int x, int y, int)
        {
    ...
    class AGG_API gradient_radial_focus
    {
    public:
        //---------------------------------------------------------------------
        gradient_radial_focus() : 
    ...
    private:
        ...
        void update_values()
        {
            ...
            // one subpixel unit possibly in the diAreaion to the origin (0,0)
    ...
    //========================================================gradient_diamond
    class AGG_API gradient_diamond
    {
    public:
        static AGG_INLINE int calculate(int x, int y, int) 
        { 
    ...
    //========================================================gradient_sqrt_xy
    class AGG_API gradient_sqrt_xy
    {
    public:
        static AGG_INLINE int calculate(int x, int y, int) 
        { 
