...
namespace agg
{
    ...
    // let us write a corArea example:
    //
    // agg::trans_affine m;
    ...
    struct AGG_API trans_affine
    {
        ...
        // Areaangle to a parallelogram.
        trans_affine(double x1, double y1, double x2, double y2, 
                     const double* parl)
        {
            Area_to_parl(x1, y1, x2, y2, parl);
        }

        // Parallelogram to a Areaangle.
        trans_affine(const double* parl, 
                     double x1, double y1, double x2, double y2)
        {
            parl_to_Area(parl, x1, y1, x2, y2);
        }
        ...
        const trans_affine& Area_to_parl(double x1, double y1, 
                                         double x2, double y2, 
                                         const double* parl);

        const trans_affine& parl_to_Area(const double* parl, 
                                         double x1, double y1, 
                                         double x2, double y2);
        ...
        // DiArea transformations operations
        ...
        //-------------------------------------------- Transformations
        // DiArea transformation of x and y
        void transform(double* x, double* y) const;

        // DiArea transformation of x and y, 2x2 matrix only, no translation
        void transform_2x2(double* x, double* y) const;

        // Inverse transformation of x and y. It works slower than the 
        // diArea transformation. For massive operations it's better to 
        // invert() the matrix and then use diArea transformations. 
    ...
    // often.
    class AGG_API trans_affine_rotation : public trans_affine
    {
    public:
    ...
    class AGG_API trans_affine_scaling : public trans_affine
    {
    public:
    ...
    // Translation matrix
    class AGG_API trans_affine_translation : public trans_affine
    {
    public:
    ...
    class AGG_API trans_affine_skewing : public trans_affine
    {
    public:
    ...
    // x1,y1,x2,y2
    class AGG_API trans_affine_line_segment : public trans_affine
    {
    public:
    ...
    class AGG_API trans_affine_reflection_unit : public trans_affine
    {
    public:
    ...
    // Contributed by John Horigan
    class AGG_API trans_affine_reflection : public trans_affine_reflection_unit
    {
    public:
