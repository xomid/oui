...
{
    //--------------------------------------------------------poly_max_coord_e
    enum AGG_API poly_max_coord_e
    {
        poly_max_coord = (1 << 30) - 1 //----poly_max_coord
    };
    
    //------------------------------------------------------------ras_conv_int
    struct AGG_API ras_conv_int
    {
    ...
    //--------------------------------------------------------ras_conv_int_sat
    struct AGG_API ras_conv_int_sat
    {
        typedef int coord_type;
        static AGG_INLINE int mul_div(double a, double b, double c)
        {
    ...
    //---------------------------------------------------------ras_conv_int_3x
    struct AGG_API ras_conv_int_3x
    {
        typedef int coord_type;
        static AGG_INLINE int mul_div(double a, double b, double c)
        {
    ...
    //--------------------------------------------------------ras_conv_dbl_3x
    struct AGG_API ras_conv_dbl_3x
    {
        typedef double coord_type;
        static AGG_INLINE double mul_div(double a, double b, double c)
        {
    ...
    class AGG_API rasterizer_sl_no_clip
    {
    public:
