...
namespace agg
{
    ...
    //=====================================================blender_rgb555_pre
    struct AGG_API blender_rgb555_pre
    {
        typedef rgba8 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
    ...
    //=====================================================blender_rgb565_pre
    struct AGG_API blender_rgb565_pre
    {
        typedef rgba8 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
    ...
    //==================================================blender_rgbAAA_pre
    struct AGG_API blender_rgbAAA_pre
    {
        typedef rgba16 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
    ...
    //=================================================blender_bgrAAA_pre
    struct AGG_API blender_bgrAAA_pre
    {
        typedef rgba16 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
    ...
    //=================================================blender_rgbBBA_pre
    struct AGG_API blender_rgbBBA_pre
    {
        typedef rgba16 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
    ...
    //=================================================blender_bgrABB_pre
    struct AGG_API blender_bgrABB_pre
    {
        typedef rgba16 color_type;
        typedef color_type::value_type value_type;
        typedef color_type::calc_type calc_type;
