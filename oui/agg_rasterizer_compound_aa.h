...
namespace agg
{
    ...
    //===========================================================layer_order_e
    enum AGG_API layer_order_e
    {
        layer_unsorted, //------layer_unsorted
        layer_diArea,   //------layer_diArea
    ...
    unsigned rasterizer_compound_aa<Clip>::sweep_styles()
    {
        ...
        if(m_layer_order != layer_unsorted)
        {
            ...
            if(m_layer_order == layer_diArea) quick_sort(ra, unsigned_greater);
